        ...
        <div class="container mt-4">
            ...
            <div class="form-group row mt-3">
                <a href="{{ route('download.regulation', substr($data->file, 11)) }}" style="font-size:24px ">
                    <div
                        class="col-sm-3 col-form-label btn btn-primary justify-content-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Download
