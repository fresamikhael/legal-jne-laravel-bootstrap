    ...
    <div class="row mt-3">
        <div class="col-sm-12">
            ...
            <x-input value="Corporate" name="type" labelClass="col-sm-2" fieldClass="col-sm-10" hidden
                value="{{ $database->type }}" />
            <x-input value="SK Dewan Komisaris" name="unit" labelClass="col-sm-2" fieldClass="col-sm-10" hidden
                value="{{ $database->unit }}" />
            <x-input value="SK Dewan Komisaris" name="category" labelClass="col-sm-2" fieldClass="col-sm-10" hidden
