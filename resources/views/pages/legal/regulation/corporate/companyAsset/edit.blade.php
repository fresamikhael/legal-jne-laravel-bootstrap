    ...
    @elseif ($database->unit == 'Kendaraan')
        <div class="row mt-3">
            <div class="col-sm-12">
                ...
                <x-input type="date" label="Jangka Waktu Awal STNK" name="date_awal" labelClass="col-sm-2"
                    value="{{ $database->date_awal }}" fieldClass="col-sm-10" />
                <x-input type="date" label="Jangka Waktu Akhir STNK" name="date_akhir" labelClass="col-sm-2"
                    value="{{ $database->date_akhir }}" fieldClass="col-sm-10" />
                <x-input label="Note" name="note" labelClass="col-sm-2" fieldClass="col-sm-10"
                    value="{{ $database->note }}" />
                <div id="file">
