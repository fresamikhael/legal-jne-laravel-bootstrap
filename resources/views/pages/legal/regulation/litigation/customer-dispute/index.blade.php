            ...
            <div class="row mt-4">
                <div class="row mt-3">
                    <div class="col-sm-12">
                        ...
                        <x-input value="Customer Dispute" name="unit" labelClass="col-sm-2" fieldClass="col-sm-10"
                            hidden />
                        <x-input value="Customer Dispute" name="category" labelClass="col-sm-2" fieldClass="col-sm-10"
                            hidden />
