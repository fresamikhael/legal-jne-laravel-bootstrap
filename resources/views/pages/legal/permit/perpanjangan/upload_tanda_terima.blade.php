...
@section('content')
    ...
    @endslot --}}
        <form class="mt-4" method="post" enctype="multipart/form-data"
            action="{{ route('legal.perpanjangan.upload-tanda-terima-update', $data->id) }}">
            @csrf
            <div class="d-flex align-items-center justify-content-between">
                <h2>Upload Tanda Terima</h2>
            </div>
            ...
            <x-input label="1. Tanda terima" name="receipt" type="file" labelClass="col-sm-4" fieldClass="col-sm-8"
                required>
            </x-input>
