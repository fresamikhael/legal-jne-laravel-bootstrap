    ...
    @endslot --}}
        ...
        <div class="row mt-3">
            ...
            <form class="mt-4" method="post" enctype="multipart/form-data"
                action="{{ route('legal.document_request.updatepostsoft', $file->id) }}">
                @csrf
                <x-input label="Kode Dokumen" name="document_code" type="text" labelClass="col-sm-2" fieldClass="col-sm-10"
                    required>
                </x-input>
                <x-input label="File Number" name="file_number" type="text" labelClass="col-sm-2" fieldClass="col-sm-10"
                    required>
                </x-input>
                <x-input label="File" name="file" type="file" labelClass="col-sm-2" fieldClass="col-sm-10" required>
                </x-input>
                {{-- <label class="col-sm-2 col-form-label">Note</label>
                <div class="mb-3 row">
                    <div class="col-sm-12">
