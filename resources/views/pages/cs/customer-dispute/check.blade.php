    ...
    <x-base>
        ...
        @if ($data->status === "APPROVED BY LEGAL LITIGASI MANAGER" || in_array(strtoupper($data->status), $status))
            ...
            @if (request('action') == "finish")
                <form action="{{ route('cs.customer-dispute.finish', [$data->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                        <div class="col-sm-3">
                            <h5>Berkas Penyelesaian Kasus :</h5>
                        </div>
                        <div class="col-sm-9">
                            <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="1. Scan Surat Tanggapan" name="file_response_letter" required/>
                            <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="2. Bukti Pengiriman" name="file_proof_shipment" required/>
                        </div>
                    </div>
            ...
            @else
                <form action="{{ route('cs.customer-dispute.close', [$data->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                        <div class="col-sm-3">
        ...
        @else
            ...
            @if ($data->status == "PENDING" || $data->status == "RETURNED BY LEGAL LITIGASI 1")
                <form action="{{ route('cs.customer-dispute.store', [$data->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @if($data->status == "RETURNED BY LEGAL LITIGASI 1")
                        @php
                            $cs = DB::table('cs')
                                ->where('form_id', $data->id)
                                ->first();
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9">
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="1. Form Kasus Sengketa Konsumen" name="file_consumer_dispute_case_form1" type="download" path="{{ route('download.litigation', [substr($cs->file_consumer_dispute_case_form, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_consumer_dispute_case_form"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="2. Kronologis Pengiriman Operasional" name="file_operational_delivery_chronology1" type="download" path="{{ route('download.litigation', [substr($cs->file_operational_delivery_chronology, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_operational_delivery_chronology"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="3. Kronologis Penanganan CS" name="file_cs_handling_chronology1" type="download" path="{{ route('download.litigation', [substr($cs->file_cs_handling_chronology, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_cs_handling_chronology"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="4. Bukti POD" name="file_pod_evidence1" type="download" path="{{ route('download.litigation', [substr($cs->file_pod_evidence, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_pod_evidence"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="5. Bukti Tanda Terima" name="file_receipt_proof1" type="download" path="{{ route('download.litigation', [substr($cs->file_receipt_proof, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_receipt_proof"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="6. Bukti Dokumentasi 1" name="file_proof_of_documentation11" type="download" path="{{ route('download.litigation', [substr($cs->file_proof_of_documentation1, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_proof_of_documentation1"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="7. Bukti Dokumentasi 2" name="file_proof_of_documentation21" type="download" path="{{ route('download.litigation', [substr($cs->file_proof_of_documentation2, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_proof_of_documentation2"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="8. Bukti Dokumentasi 3" name="file_proof_of_documentation31" type="download" path="{{ route('download.litigation', [substr($cs->file_proof_of_documentation3, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_proof_of_documentation3"/>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="9. Dokumen pendukung lainnya" name="file_other_supporting_document1" type="download" path="{{ route('download.litigation', [substr($cs->file_other_supporting_document, 11)]) }}">Unduh <i class="fa fa-download"></i></x-file>
                                <x-file labelClass="col-sm-5" fieldClass="col-sm-7" label="" name="file_other_supporting_document"/>
                                <x-input labelClass="col-sm-5" fieldClass="col-sm-7" label="Nominal penawaran ganti kerugian" prefix="Rp" name="nominal_indemnity_offer1" value="{{ $cs->nominal_indemnity_offer }}" readOnly/>
                                <x-input labelClass="col-sm-5" fieldClass="col-sm-7" label=" " prefix="Rp" name="nominal_indemnity_offer"/>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-sm-3">
