        ...
        return (
            <React.Fragment>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select onChange={ (e) => setType(e.target.value) } required name="corporate_type" id="corporate_type" class="form-select trigger-date" aria-label="Default select example">
